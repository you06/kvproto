...
impl UpdateKeyspaceStateRequest {
    ...
    // .keyspacepb.KeyspaceState newState = 3;


    pub fn get_new_state(&self) -> KeyspaceState {
        self.new_state
    }
    pub fn clear_new_state(&mut self) {
        self.new_state = KeyspaceState::Enabled;
    }

    // Param is passed by value, moved
    pub fn set_new_state(&mut self, v: KeyspaceState) {
        self.new_state = v;
    }
}
...
impl ::protobuf::Message for UpdateKeyspaceStateRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    if wire_type == ::protobuf::wire_format::WireTypeVarint {self.new_state = is.read_enum()?;} else {return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));}
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.new_state != KeyspaceState::Enabled {
            my_size += ::protobuf::rt::enum_size(3, self.new_state);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.new_state != KeyspaceState::Enabled {
            os.write_enum(3, self.new_state.value())?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::PbPrint for UpdateKeyspaceStateRequest {
    ...
    fn fmt(&self, name: &str, buf: &mut String) {
        ...
        ::protobuf::PbPrint::fmt(&self.header, "header", buf);
        ::protobuf::PbPrint::fmt(&self.id, "id", buf);
        ::protobuf::PbPrint::fmt(&self.new_state, "new_state", buf);
        if old_len < buf.len() {
          buf.push(' ');
        }
        buf.push('}');
...
impl ::std::fmt::Debug for UpdateKeyspaceStateRequest {
    ...
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ...
        ::protobuf::PbPrint::fmt(&self.header, "header", &mut s);
        ::protobuf::PbPrint::fmt(&self.id, "id", &mut s);
        ::protobuf::PbPrint::fmt(&self.new_state, "new_state", &mut s);
        write!(f, "{}", s)
    }
}
