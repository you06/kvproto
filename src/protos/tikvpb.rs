...
pub enum BatchCommandsRequest_Request_oneof_cmd {
    ...
    PrepareFlashbackToVersion(super::kvrpcpb::PrepareFlashbackToVersionRequest),
...
impl ::protobuf::PbPrint for BatchCommandsRequest_Request_oneof_cmd {
    fn fmt(&self, name: &str, buf: &mut String) {
        match self {
            ...
            BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(v) => ::protobuf::PbPrint::fmt(v, name, buf),
...
impl BatchCommandsRequestRequest {
    ...
    pub fn get_prepare_flashback_to_version(&self) -> &super::kvrpcpb::PrepareFlashbackToVersionRequest {
        match self.cmd {
            ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(ref v)) => v,
            _ => super::kvrpcpb::PrepareFlashbackToVersionRequest::default_instance(),
        }
    }
    pub fn clear_prepare_flashback_to_version(&mut self) {
        self.cmd = ::std::option::Option::None;
    }

    pub fn has_prepare_flashback_to_version(&self) -> bool {
        match self.cmd {
            ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_prepare_flashback_to_version(&mut self, v: super::kvrpcpb::PrepareFlashbackToVersionRequest) {
        self.cmd = ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(v))
    }

    // Mutable pointer to the field.
    pub fn mut_prepare_flashback_to_version(&mut self) -> &mut super::kvrpcpb::PrepareFlashbackToVersionRequest {
        if let ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(_)) = self.cmd {
        } else {
            self.cmd = ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(super::kvrpcpb::PrepareFlashbackToVersionRequest::new()));
        }
        match self.cmd {
            ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_prepare_flashback_to_version(&mut self) -> super::kvrpcpb::PrepareFlashbackToVersionRequest {
        if self.has_prepare_flashback_to_version() {
            match self.cmd.take() {
                ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(v)) => v,
                _ => panic!(),
            }
        } else {
            super::kvrpcpb::PrepareFlashbackToVersionRequest::new()
        }
    }
...
impl ::protobuf::Message for BatchCommandsRequestRequest {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(ref v)) = self.cmd {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                36 => {
                    ...
                    self.cmd = ::std::option::Option::Some(BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(is.read_message()?));
                },
                255 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.cmd {
            match v {
                ...
                &BatchCommandsRequest_Request_oneof_cmd::PrepareFlashbackToVersion(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
...
pub enum BatchCommandsResponse_Response_oneof_cmd {
    ...
    PrepareFlashbackToVersion(super::kvrpcpb::PrepareFlashbackToVersionResponse),
...
impl ::protobuf::PbPrint for BatchCommandsResponse_Response_oneof_cmd {
    fn fmt(&self, name: &str, buf: &mut String) {
        match self {
            ...
            BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(v) => ::protobuf::PbPrint::fmt(v, name, buf),
...
impl BatchCommandsResponseResponse {
    ...
    pub fn get_prepare_flashback_to_version(&self) -> &super::kvrpcpb::PrepareFlashbackToVersionResponse {
        match self.cmd {
            ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(ref v)) => v,
            _ => super::kvrpcpb::PrepareFlashbackToVersionResponse::default_instance(),
        }
    }
    pub fn clear_prepare_flashback_to_version(&mut self) {
        self.cmd = ::std::option::Option::None;
    ...
    pub fn has_prepare_flashback_to_version(&self) -> bool {
        match self.cmd {
            ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_prepare_flashback_to_version(&mut self, v: super::kvrpcpb::PrepareFlashbackToVersionResponse) {
        self.cmd = ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(v))
    }

    // Mutable pointer to the field.
    pub fn mut_prepare_flashback_to_version(&mut self) -> &mut super::kvrpcpb::PrepareFlashbackToVersionResponse {
        if let ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(_)) = self.cmd {
        } else {
            self.cmd = ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(super::kvrpcpb::PrepareFlashbackToVersionResponse::new()));
        }
        match self.cmd {
            ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_prepare_flashback_to_version(&mut self) -> super::kvrpcpb::PrepareFlashbackToVersionResponse {
        if self.has_prepare_flashback_to_version() {
            match self.cmd.take() {
                ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(v)) => v,
                _ => panic!(),
            }
        } else {
            super::kvrpcpb::PrepareFlashbackToVersionResponse::new()
        }
    }
...
impl ::protobuf::Message for BatchCommandsResponseResponse {
    fn is_initialized(&self) -> bool {
        ...
        if let Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(ref v)) = self.cmd {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                36 => {
                    ...
                    self.cmd = ::std::option::Option::Some(BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(is.read_message()?));
                },
                255 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.cmd {
            match v {
                ...
                &BatchCommandsResponse_Response_oneof_cmd::PrepareFlashbackToVersion(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
