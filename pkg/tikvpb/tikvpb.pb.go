...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_4262bda0345ee7a5, []int{0}
}
...
type BatchCommandsRequest_Request struct {
	...
	//	*BatchCommandsRequest_Request_Test
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_4262bda0345ee7a5, []int{0, 0}
}
...
type BatchCommandsRequest_Request_Test struct {
	Test *BatchCommandTestRequest `protobuf:"bytes,255,opt,name=Test,oneof"`
}
...
func (*BatchCommandsRequest_Request_Test) isBatchCommandsRequest_Request_Cmd()           {}
...
func (m *BatchCommandsRequest_Request) GetTest() *BatchCommandTestRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_Test); ok {
		return x.Test
	}
	return nil
}
...
func (*BatchCommandsRequest_Request) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsRequest_Request_OneofMarshaler, _BatchCommandsRequest_Request_OneofUnmarshaler, _BatchCommandsRequest_Request_OneofSizer, []interface{}{
		...
		(*BatchCommandsRequest_Request_Test)(nil),
	}
}
...
func _BatchCommandsRequest_Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsRequest_Request_Test:
...
func _BatchCommandsRequest_Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 255: // cmd.Test
		...
		msg := new(BatchCommandTestRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_Test{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_4262bda0345ee7a5, []int{1}
}
...
type BatchCommandsResponse_Response struct {
	...
	//	*BatchCommandsResponse_Response_Test
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_4262bda0345ee7a5, []int{1, 0}
}
...
type BatchCommandsResponse_Response_Test struct {
	Test *BatchCommandTestResponse `protobuf:"bytes,255,opt,name=Test,oneof"`
}
...
func (*BatchCommandsResponse_Response_Test) isBatchCommandsResponse_Response_Cmd()           {}
...
func (m *BatchCommandsResponse_Response) GetTest() *BatchCommandTestResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_Test); ok {
		return x.Test
	}
	return nil
}
...
func (*BatchCommandsResponse_Response) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsResponse_Response_OneofMarshaler, _BatchCommandsResponse_Response_OneofUnmarshaler, _BatchCommandsResponse_Response_OneofSizer, []interface{}{
		...
		(*BatchCommandsResponse_Response_Test)(nil),
	}
}
...
func _BatchCommandsResponse_Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsResponse_Response_Test:
		_ = b.EncodeVarint(255<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Test); err != nil {
			return err
		}
...
func _BatchCommandsResponse_Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 255: // cmd.Test
		...
		msg := new(BatchCommandTestResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_Test{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_4262bda0345ee7a5, []int{2}
}
...
func (m *BatchCommandTestRequest) Reset()         { *m = BatchCommandTestRequest{} }
func (m *BatchCommandTestRequest) String() string { return proto.CompactTextString(m) }
func (*BatchCommandTestRequest) ProtoMessage()    {}
func (*BatchCommandTestRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_4262bda0345ee7a5, []int{3}
}
func (m *BatchCommandTestRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BatchCommandTestRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BatchCommandTestRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *BatchCommandTestRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchCommandTestRequest.Merge(dst, src)
}
func (m *BatchCommandTestRequest) XXX_Size() int {
	return m.Size()
}
func (m *BatchCommandTestRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchCommandTestRequest.DiscardUnknown(m)
}

var xxx_messageInfo_BatchCommandTestRequest proto.InternalMessageInfo

func (m *BatchCommandTestRequest) GetTestId() uint64 {
	if m != nil {
		return m.TestId
	}
	return 0
...
func (m *BatchCommandTestRequest) GetDelayTime() uint64 {
	if m != nil {
		return m.DelayTime
	}
	return 0
...
type BatchCommandTestResponse struct {
	// Id of the test response, should be same with the one in the request
	TestId uint64 `protobuf:"varint,1,opt,name=test_id,json=testId,proto3" json:"test_id,omitempty"`
	// The time when the response is generated, milliseconds since January 1, 1970 UTC (the "epoch")
	ReplyTime uint64 `protobuf:"varint,2,opt,name=reply_time,json=replyTime,proto3" json:"reply_time,omitempty"`
	// The time when the response is sent out, milliseconds since the "epoch"
	ReplySendTime        uint64   `protobuf:"varint,3,opt,name=reply_send_time,json=replySendTime,proto3" json:"reply_send_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *BatchCommandTestResponse) Reset()         { *m = BatchCommandTestResponse{} }
func (m *BatchCommandTestResponse) String() string { return proto.CompactTextString(m) }
func (*BatchCommandTestResponse) ProtoMessage()    {}
func (*BatchCommandTestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_4262bda0345ee7a5, []int{4}
}
func (m *BatchCommandTestResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BatchCommandTestResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BatchCommandTestResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *BatchCommandTestResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchCommandTestResponse.Merge(dst, src)
}
func (m *BatchCommandTestResponse) XXX_Size() int {
	return m.Size()
}
func (m *BatchCommandTestResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchCommandTestResponse.DiscardUnknown(m)
}

var xxx_messageInfo_BatchCommandTestResponse proto.InternalMessageInfo

func (m *BatchCommandTestResponse) GetTestId() uint64 {
	if m != nil {
		return m.TestId
	}
	return 0
...
func (m *BatchCommandTestResponse) GetReplyTime() uint64 {
	if m != nil {
		return m.ReplyTime
	}
	return 0
...
func (m *BatchCommandTestResponse) GetReplySendTime() uint64 {
	if m != nil {
		return m.ReplySendTime
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*BatchCommandTestRequest)(nil), "tikvpb.BatchCommandTestRequest")
	proto.RegisterType((*BatchCommandTestResponse)(nil), "tikvpb.BatchCommandTestResponse")
}
...
func (m *BatchCommandsRequest_Request_Test) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Test != nil {
		dAtA[i] = 0xfa
		i++
		dAtA[i] = 0xf
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Test.Size()))
		n26, err := m.Test.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *BatchCommandsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RequestIds) > 0 {
		dAtA28 := make([]byte, len(m.RequestIds)*10)
		var j27 int
		for _, num := range m.RequestIds {
			for num >= 1<<7 {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(j27))
...
func (m *BatchCommandsResponse_Response) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Cmd != nil {
		nn29, err := m.Cmd.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn29
...
func (m *BatchCommandsResponse_Response_Get) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Get != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Get.Size()))
		n30, err := m.Get.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *BatchCommandsResponse_Response_Prewrite) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Prewrite != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Prewrite.Size()))
		n32, err := m.Prewrite.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *BatchCommandsResponse_Response_Cleanup) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Cleanup != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Cleanup.Size()))
		n35, err := m.Cleanup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *BatchCommandsResponse_Response_BatchGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BatchGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.BatchGet.Size()))
		n36, err := m.BatchGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *BatchCommandsResponse_Response_BatchRollback) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BatchRollback != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.BatchRollback.Size()))
		n37, err := m.BatchRollback.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *BatchCommandsResponse_Response_ScanLock) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ScanLock != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ScanLock.Size()))
		n38, err := m.ScanLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *BatchCommandsResponse_Response_ResolveLock) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResolveLock != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ResolveLock.Size()))
		n39, err := m.ResolveLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *BatchCommandsResponse_Response_RawGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawGet.Size()))
		n42, err := m.RawGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
func (m *BatchCommandsResponse_Response_RawBatchGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchGet.Size()))
		n43, err := m.RawBatchGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *BatchCommandsResponse_Response_RawPut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawPut != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawPut.Size()))
		n44, err := m.RawPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *BatchCommandsResponse_Response_RawBatchPut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchPut != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchPut.Size()))
		n45, err := m.RawBatchPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *BatchCommandsResponse_Response_RawDelete) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawDelete != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawDelete.Size()))
		n46, err := m.RawDelete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *BatchCommandsResponse_Response_RawBatchDelete) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchDelete != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchDelete.Size()))
		n47, err := m.RawBatchDelete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *BatchCommandsResponse_Response_RawScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawScan != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawScan.Size()))
		n48, err := m.RawScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *BatchCommandsResponse_Response_RawDeleteRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawDeleteRange != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawDeleteRange.Size()))
		n49, err := m.RawDeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *BatchCommandsResponse_Response_RawBatchScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchScan != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchScan.Size()))
		n50, err := m.RawBatchScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *BatchCommandsResponse_Response_Coprocessor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Coprocessor != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Coprocessor.Size()))
		n51, err := m.Coprocessor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *BatchCommandsResponse_Response_Test) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Test != nil {
		dAtA[i] = 0xfa
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Test.Size()))
		n52, err := m.Test.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
...
func (m *BatchCommandTestRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BatchCommandTestRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *BatchCommandTestResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BatchCommandTestResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.ReplyTime != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ReplyTime))
	}
	if m.ReplySendTime != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ReplySendTime))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *BatchCommandsRequest_Request_Test) Size() (n int) {
	var l int
	_ = l
	if m.Test != nil {
		l = m.Test.Size()
...
func (m *BatchCommandsResponse_Response_Test) Size() (n int) {
	var l int
	_ = l
	if m.Test != nil {
		l = m.Test.Size()
...
func (m *BatchCommandTestRequest) Size() (n int) {
	var l int
	_ = l
	if m.TestId != 0 {
...
func (m *BatchCommandTestResponse) Size() (n int) {
	var l int
	_ = l
	if m.TestId != 0 {
		n += 1 + sovTikvpb(uint64(m.TestId))
	...
	if m.ReplyTime != 0 {
		n += 1 + sovTikvpb(uint64(m.ReplyTime))
	}
	if m.ReplySendTime != 0 {
		n += 1 + sovTikvpb(uint64(m.ReplySendTime))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *BatchCommandsRequest_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 255:
			...
			v := &BatchCommandTestRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_Test{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTikvpb(dAtA[iNdEx:])
...
func (m *BatchCommandsResponse_Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 255:
			...
			v := &BatchCommandTestResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_Test{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTikvpb(dAtA[iNdEx:])
...
func (m *BatchCommandTestRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BatchCommandTestRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BatchCommandTestRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BatchCommandTestResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BatchCommandTestResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BatchCommandTestResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplySendTime", wireType)
			}
			m.ReplySendTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReplySendTime |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_4262bda0345ee7a5) }

var fileDescriptor_tikvpb_4262bda0345ee7a5 = []byte{
	// 1550 bytes of a gzipped FileDescriptorProto
	,
}
