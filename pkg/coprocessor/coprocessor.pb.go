...
type StoreBatchTask struct {
	...
	// If cache is enabled, TiKV returns cache hit instead of data if
	// its last version matches this `cache_if_match_version`.
	IsCacheEnabled       bool     `protobuf:"varint,6,opt,name=is_cache_enabled,json=isCacheEnabled,proto3" json:"is_cache_enabled,omitempty"`
	CacheIfMatchVersion  uint64   `protobuf:"varint,7,opt,name=cache_if_match_version,json=cacheIfMatchVersion,proto3" json:"cache_if_match_version,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *StoreBatchTask) GetIsCacheEnabled() bool {
	if m != nil {
		return m.IsCacheEnabled
	}
	return false
...
func (m *StoreBatchTask) GetCacheIfMatchVersion() uint64 {
	if m != nil {
		return m.CacheIfMatchVersion
	}
	return 0
...
func (m *StoreBatchTaskResponse) GetIsCacheHit() bool {
	if m != nil {
		return m.IsCacheHit
	}
	return false
...
func (m *StoreBatchTaskResponse) GetCacheLastVersion() uint64 {
	if m != nil {
		return m.CacheLastVersion
	}
	return 0
...
func (m *StoreBatchTaskResponse) GetCanBeCached() bool {
	if m != nil {
		return m.CanBeCached
	}
	return false
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
